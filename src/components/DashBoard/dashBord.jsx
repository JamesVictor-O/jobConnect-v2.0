...
const DashBord = () => {
    return (
        <div className=" h-screen flex md:flex-row">
            ...
            <div className="border bg-white md:px-6 px-3 w-[100%] h-[100%]">
                ...
                <div className="border bg-blue-50 flex flex-row justify-between p-3 mt-6 md:mt-12">
                    <div>
                        ...
                        <div className="mt-4 flex flex-row w-[100%]">
                            <button className="bg-blue-400 p-2 text-white rounded-lg md:text-[16px] text-[11px]">Accept the offer</button>
                            <button className="bg-white p-2 text-black border ml-4 rounded-lg md:text-[16px] text-[11px]">Send message</button>
                        </div>
                    </div>
                ...
                <div className="border p-3 mt-12 bg-gray-200">
                    ...
                    <div className="flex justify-between flex-row mt-2">
                        <button className="bg-white p-2 text-black border text-[12px] rounded-lg md:w-[9%]  flex items-center justify-between">
                            See details
                            <GrLinkNext/>
                        </button>
                    </div>
            ...
            <div className="ml-2 hidden md:flex flex-col w-[20%]">
                <div>
                    <Calender/>
               </div>
               <div>
